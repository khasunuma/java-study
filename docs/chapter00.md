...
このドキュメントは以下のプログラミング言語の使用経験が多少なりともあるプログラマを対象としています。

- Java (Java SE 6 または Java SE 7)
- C (ANSI/ISO C99 規格)
- Python (バージョン 2.x 系)
- JavaScript (ECMA-262 第 3 版以降)
- Visual Basic (Visual Basic 6.0 または Visual Basic for Applications)

オブジェクト指向プログラミングに関する知識はなくても構いませんが、構造化プログラミングの概要を理解していると読み進めやすいと思われます。
...
【バージョン】 で示した情報は、Java SE 6 または Java SE 7 を経験している Java プログラマ向けの差分情報です。
