...
日付の表現には、calendar date、ordinal date、week date の 3 種類が用意されています。良く用いられるのは calendar date です。

|種類|情報|表現|例|
|----|----|----|----|
|calendar date|年・月・日|YYYY-MM-DD|2015-07-11|
|ordinal date|年・年始からの通算日|YYYY-DDD|2015-192|
|week date|年・週・曜日|YYYY-Www-D|2015-W29-6|
