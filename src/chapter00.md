...
第 3 章はプログラミング言語全般に共通する事柄でもあることから、C、JavaScript、Python、Visual Basic の対応する構文についても注記しています。
...
|バージョン|デメリット|
|--------|--------|
|Java SE 7|ジェネリクス (総称型) の省略表記がサポートされるが、型推論が稚拙で使い勝手に難がある。|
|Java SE 6|Java SE 7 以降で導入されたユーティリティや省略表記が利用できず、ソースコード記述が煩雑になりがち。|
